...
namespace MilitaryFaculty.Presentation.Custom
{
    public class ConferenceAppCommandsModule : ICommandContainerModule
    {
        ...
        public void RegisterModule(CommandContainer container)
        {
            ...
            container.RegisterCommand<Conference>(GlobalAppCommands.AddConference,
                                                  OnAddConference,
                                                  CanAddConference);

            container.RegisterCommand<Conference>(GlobalAppCommands.UpdateConference,
                                                  OnUpdateConference,
                                                  CanUpdateConference);

            container.RegisterCommand<Conference>(GlobalAppCommands.RemoveConference,
                                                  OnRemoveConference);
        }
