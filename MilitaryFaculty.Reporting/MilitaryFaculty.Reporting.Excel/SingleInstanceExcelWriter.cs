...
namespace MilitaryFaculty.Reporting.Excel
{
    public class SingleInstanceExcelWriter
    {
        ...
        public void PutName(string value)
        {
            ...
            ExcelRange range = _excelWorksheet.Cells[_curLine, _firstColumn, _curLine + 1, _maxValueColumn];
            range.Merge = true;
            range.Value = value;
        ...
        public void PutSubName(string value)
        {
            ...
            ExcelRange range = _excelWorksheet.Cells[_curLine, _firstColumn, _curLine, _maxValueColumn];
            range.Merge = true;
            range.Value = value;
            range.Style.Font.Bold = true;
        ...
        public void PutResults(string name, int value)
        {
            ...
            //Name writing
            ExcelRange range = _excelWorksheet.Cells[_curLine, _firstColumn, _curLine + 1, _nameColumn];
            range.Merge = true;
            range.Style.Font.Bold = true;
            range.Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
            range.Style.VerticalAlignment = ExcelVerticalAlignment.Center;
        ...
        {
            int lastLine = _curLine - 1;

            ExcelRange range = _excelWorksheet.Cells[_firstLine, _firstColumn, lastLine, _maxValueColumn];
